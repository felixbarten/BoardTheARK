...
var main = function () {
	...
	// votes are on different spots depending on the dashboard.
	function getAmountOfVotes() {
		if (/classicdelegate/.test(window.location.href)) {
			return jQ("div#largeStats div:nth-child(1) span.statValue").text();
		}
		return jQ("div#largeStats div:nth-child(2) span.statValue").text();
	}
